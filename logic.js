...
function pull(cityVal, tattooStyle) {
    ...
    $.ajax({
        ...
        var styleArray = ["newSchool", "traditional", "realism", "script", "watercolor","japanese","geometric"]
...
function initMap(latitude, longitude) {
    ...
    var address = "https://www.mapquestapi.com/staticmap/v5/map?key=loorHzIG2sew2tOMV3HYNMxhCMwd8i8i&locations=" + latitude + "," + longitude + "&zoom=15&size=400,400&type=hyb"
...
function rowExplanation() {
    ...
    rowExplanation.addClass("explanation")
    rowExplanation.css({
